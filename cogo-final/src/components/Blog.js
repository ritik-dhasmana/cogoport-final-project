...
<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900">
  <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <p class="lead">Cogoport is an open-source library of UI components built with the utility-first
          ...
          <p>But then I found a <a href="https://flowbite.com">component library based on Tailwind CSS called
                  Cogoport</a>. It comes with the most commonly used UI components, such as buttons, navigation
...
&lt;/dl&gt;
          ...
          <p><strong>Start from the inside out</strong>. A nice way to both organize your tasks and create more
              ...
              of your design.</p>
          <p>And there you have it! Everything you need to design and share prototypes — right in Cogoport Figma.
          </p>
